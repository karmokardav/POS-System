<div class="flex items-center justify-between md:justify-between px-4 py-3 border-b border-gray-200">

    <div class="hidden xl:block">
        <form>
            <div class="relative">
                <span class="absolute -translate-y-1/2 pointer-events-none left-4 top-3/4">
                ...
                <input type="text" placeholder="Search or type command..."
                    class="h-full w-full rounded-lg border border-gray-200 bg-transparent py-2 pl-12 pr-14 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:outline-none focus:border-[#F2CBB8] focus:ring-1 focus:ring-[#F2CBB8] xl:w-[430px]" />
                <button
                    class="absolute right-2.5 top-6/7 inline-flex -translate-y-1/2 items-center gap-0.5 rounded-lg border border-gray-200 bg-gray-50 px-[7px] py-[4.5px] text-xs -tracking-[0.2px] text-gray-500 hover:border-[#F2CBB8] ">
                    <span> ⌘ </span>
                    <span> K </span>
                </button>
            </div>
    ...
    closeDropdown() {
        ...
        <button class="flex items-center text-gray-700 dark:text-gray-400" @click.prevent="toggleDropdown()"
            ...
            <span class="mr-3 overflow-hidden rounded-full h-11 w-11">
                <img src="/images/hridoy.png" alt="User" />
            </span>
        </button>
